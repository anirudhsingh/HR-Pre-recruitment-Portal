<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RSI.aspx.cs" Inherits="Exam.WebForm2" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<meta http-equiv="expires" content="-1" />
    ...
    <title>Mahindra Holiday RSI Page</title>
    <link href="../css/Stylesheet_RSI.css" rel="stylesheet" type="text/css" />
    ...
    <div id="rsi-container">
        <div class="rsi_header rsi_header_image">
            ...
            <table width="100%">
               ...
               <td style="width:20%" align="left"> RSI Instrument</td>
               <td style="width:70%" align="right"><asp:Label ID="lblCandidateDetails" Font-Size="Medium"
                       runat="server" Font-Bold="False" ForeColor="#0D9DDB"></asp:Label>
       ...
       <%-- <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <div class="rsiquestion_text">
            ...
            <div class="desc">
                <p style="width: 92%">
                    ...
                    The scores for ‘a’ and ‘b’ must add up to 3. For example: 0 and 3, or 1 and 2 etc.) Do not use fractions such as 1.5.
                </p>
            </div>
        </div>
        <div class="rsi_clear">
                                ...
                                <ContentTemplate>
                                    <td colspan="2" align="left" style="height: 100%;width:97%" >
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                                            ...
                                            PageSize="12" OnDataBinding="GridView1_DataBinding" OnDataBound="GridView1_DataBound"
        ...
        ValidationExpression="^[0-3]*$" ></asp:RegularExpressionValidator> 
                                                        </div>
                                                    </ItemTemplate>
